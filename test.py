...
user_nakshatra = NAKSHATRAS.PUNARPOOSAM
num_days = 90
mins_step = 30
a = Almanac()
t0 = a.time_scale.utc(2020, 4, 1)
t1 = a.time_scale.utc(2020, 12, 31)
...
for k in range(idxs.shape[0]):
    cur_id = idxs[k,0]
    print(a.time.utc_datetime()[cur_id].astimezone(), a.day[cur_id], a.nakshaktra.name[cur_id], a.thithi.name[cur_id], a.time.utc_datetime()[cur_id].toordinal())
